...
local Lirfen = https.request("https://Lirfen.gamemodsm.xyz/index.php?User=@"..SUDOID)
local Jsoninfo = JSON.decode(Lirfen)
...
Lirfen_Msg = 'غير متفاعل ⚡️' 
elseif msgs < 400 then 
Lirfen_Msg = 'استمر بطل 💫' 
elseif msgs < 700 then 
Lirfen_Msg = 'ملك التفاعل 🌙' 
elseif msgs < 1200 then 
Lirfen_Msg = 'اسد التفاعل ✨' 
elseif msgs < 2000 then 
Lirfen_Msg = 'اقوى تفاعل 🔥' 
elseif msgs < 3500 then 
Lirfen_Msg = 'اجمل تفاعل 💥'  
elseif msgs < 4000 then 
Lirfen_Msg = 'تفاعل روعه 🌜' 
elseif msgs < 4500 then 
Lirfen_Msg = 'التفاعل المثالي ⭐️' 
elseif msgs < 5500 then 
Lirfen_Msg = 'اقوى متفاعل 😎' 
elseif msgs < 7000 then 
Lirfen_Msg = 'ملك التفاعل 🤹‍♂️' 
...
--------------------------------------------------------------------------------------------------------------
function DevLirfen(msg,data) -- Source Lirfen 
if msg then
...
DevLirfenr = '🌐┋مرحبا بك في بوت الحمايه'..'\n🎫┋آنا آختصاصي حمايه المجموعات'..'\n📛┋مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...'..'\n\n📨┋ارسل ما تريد وسارسله الى المطور'..'\n\n🚶🏻‍♂️'
end 
send(msg.chat_id_, msg.id_, DevLirfenr) 
end
end
...
os.execute('wget https://raw.githubusercontent.com/TeamLirfen/Lirfen/master/Lirfen.lua')
...
--------------------------------------------------------------------------------------------------------------
if Lirfen_Msg and not Special(msg) then  
...
send(msg.chat_id_,0,"👤┋المستخدم : {["..data.first_name_.."](T.ME/Lirfen)}\n📛┋["..Lirfen_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
os.execute('rm -rf Lirfen.lua')
os.execute('wget https://raw.githubusercontent.com/TeamLirfen/Lirfen/master/Lirfen.lua')
send(msg.chat_id_, msg.id_,'♻┋ تم تحديث السورس \n👤┋ مــن قـبـل ⊰• ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Lirfen')..')') 
dofile('Lirfen.lua')  
end
...
Text = [[
🔰┇اهلا بك في سورس صاقط
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⚡┋[كود التنصيب السورس](https://t.me/Lirfen)

📺┋[قناه السورس صاقط](http://t.me/Lirfen)

®┋[گروب دعم السورس](https://t.me/joinchat/GLOSYU6g4O2QBqlZdOaBKQ)

👤┋[مطور السورس](http://t.me/YYBYY)

👤┋[التواصل المحظورين](http://t.me/DZSBOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤┋ مــن قـبـل ⊰• ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Lirfen')..') \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n📌┋ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┋ مــن قـبـل ⊰• ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Lirfen')..')\n📌┋ تـم قفـل التاك بالكتم')  
end,nil)   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┋المستخدم » ['..result.title_..'](t.me/'..(text1[3] or 'Lirfen')..')'..'\n📬┋ تم رفعهہ‌‏ '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local Json_config = JSON.decode(Lirfen)
