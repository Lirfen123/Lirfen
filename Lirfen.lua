...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Lirfen.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BS", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Lirfen -X kill
screen -S Lirfen ./Lirfen
done
]])  
file:close() 
...
local Lirfen_Msg = ''  
if msgs < 100 then 
Lirfen_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Lirfen_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Lirfen_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Lirfen_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Lirfen_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Lirfen_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Lirfen_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Lirfen_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Lirfen_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
Lirfen_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Lirfen_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Lirfen_Msg = 'امبروطور التفاعل☣️' 
elseif msgs < 10000000000 then 
Lirfen_Msg = 'رب التفاعل💖'  
end 
return Lirfen_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceLirfen(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Lirfen_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf Lirfen.lua')
os.execute('wget https://raw.githubusercontent.com/kalerbot/kaler/master/Lirfen.lua')
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..Lirfenk..''..Lirfen..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤¦ العضو » ['..result.title_..'](t.me/'..(username or 'DEVLirfen')..')'
...
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVLirfen')..')'
status  = '\n📫¦ تم ترقيته مطور في البوت'
...
local Lirfen_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Lirfen_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Lirfen_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/DEVLirfen)}\n📛¦["..Lirfen_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/DEVLirfen)}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
📮¦ Welcome to private source Lirfen
┄─━━☆~~~~~~☆━━─┄
🔰¦ ➥ [CH》soruce](t.me/Lirfen)

🔱¦ ➥ [Tawsl](t.me/DZSBOT)

📍¦ ➥ [dev soruce](t.me/VCVVVV)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVLirfen')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVLirfen')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
local UserName = (b.username_ or "Lirfen")
...
usertext = '\n👤¦ المستخدم » ['..result.title_..'](t.me/'..(username or 'DEVLirfen')..')'
statusk  = '\n📫¦ تم طرده من هنا'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
 usertext = '\n👤¦ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVLirfen')..')'
 statusk  = '\n📫¦ تم طرده من هنا'
send(msg.chat_id_, msg.id_, usertext..statusk)
else
 usertext = '\n👤¦ المستخدم » '..userid..''
...
time = times * 60
local function Restricted(Kara,Lirfen)
if tonumber(Lirfen.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(Lirfen.sender_user_id_,msg.chat_id_)..' )')
return false  
end
if Can_or_NotCan(Lirfen.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(Lirfen.sender_user_id_,msg.chat_id_)..' )')
else
MuteUser(msg.chat_id_,Lirfen.sender_user_id_,msg.date_+time)
local function name(kara,Lirfen)
if Lirfen.username_ == '' then name = Lirfen.first_name_ else name = Lirfen.username_ end
send(msg.chat_id_,msg.id_,"⚠ ¦ العضو《["..name.."](tg://user?id="..Lirfen.sender_user_id_..")》\nا┄─━━◉━━─┄\n⏳¦ تم كتم لمدة "..times.." دقايق ⏰")
end
getUser(Lirfen.sender_user_id_,name)
end
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else
...
t = "\n📌¦ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local Lirfen_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..Lirfen_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز 🕵🏻‍♀️' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DEVLirfen')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..Lirfen_Msg[math.random(#Lirfen_Msg)]..']') 
return false
end
...
Lirfen = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Lirfen)
...
--------------------------------------------------------------------------------------------------------------
SourceLirfen(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local Lirfenbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if Lirfenbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Lirfenbot.."] \n") 
